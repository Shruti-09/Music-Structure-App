    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        artist1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent artist1Intent = new Intent(ArtistsActivity.this, ArtistListActivity.class);
        ...
        artist.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                Intent artistIntent = new Intent(ArtistsActivity.this, ArtistsActivity.class);
